          ...
          <div className="w-full md:w-1/2 p-8 shadow-md rounded-lg">
            ...
            <Form method="post" className="mt-4 space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-[#faa307] text-sm">
                  Olvidé mi contraseña
                </a>
              </div>

              <button
                className="w-full bg-[#faa307] font-black text-white p-2 rounded-lg font-bold hover:bg-yellow-600"
            ...
            <p className="mt-4 text-center text-gray-600 text-sm">
              ...
              <a href="/register" className="text-[#faa307]">
                Regístrate
              </a>
            </p>
          </div>
